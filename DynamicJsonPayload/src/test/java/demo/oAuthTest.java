...
//		String URL = driver.getCurrentUrl();
		...
		GetCourse_response.getCourses().getApi().get(1).getCourseTitle();
		
		
		List<Api> Apicourse = GetCourse_response.getCourses().getApi();
		...
		//Get the course names of WebAutomation
				...
				List<pojo.webAutomation> w=GetCourse_response.getCourses().getWebAutomation();
